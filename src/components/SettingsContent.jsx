...
export default function SettingsContent({ onClose }) {
  ...
  return (
    <div className="">
      ...
      className="absolute bottom-10 mt-5 w-[10vw] bg-[#d1ee80] hover:bg-[#b9d66b] border-3 border-[#a2c93b]
                  text-4xl text-white rounded-md drop-shadow-[3px_3px_3px_rgba(0,0,0,0.3)] py-2 transition"
      >
        Sign Out
      </button>
    </div>
