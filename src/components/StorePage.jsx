...
export default function StorePage({ onClose }) {
  return (
    <div className="w-[35vw] h-[80vh] mt-[1vh] p-1">
      {/* Main light beige container */}
      <div className="w-[33vw] h-full bg-[#F1E2D4] rounded-2xl p-3 overflow-hidden flex flex-col">
            ...
            >
              ...
              <button className="absolute bottom-2 left-5 right-5 bg-[#b6e5b6] hover:bg-[#a8d8a8] rounded-lg px-3 py-1.5 flex items-center justify-center gap-2 shadow-md transition-colors duration-200">
                <img
                  ...
                  className="w-5 h-5"
                />
                <span className="text-[#2d5016] font-semibold text-base">50</span>
              </button>
            </div>
          ))}
        </div>
